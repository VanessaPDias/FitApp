...
async function aoCarregarPagina() {
    ...
    document.querySelector("#btn-imprimir").onclick = imprimirListaDePlanos;
...
async function buscarPlanos() {
    try {
        ...
        listaDePlanos = await servicos.buscarDados(token, nome, status);
...
function imprimirListaDePlanos() {
    ...
    var docDefinition = {
        ...
        content: [
            ...
            {
                stack: [
                    { text: 'Lista de Planos:', style: 'subheader' },
                    {
                        style: 'tableExample',
                        table: {
                            headerRows: 1,
